<nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white"
    ...
    <a class="navbar-brand pe-3 ps-4 ps-lg-2" href="index.html"><span class="purple-text">Campus</span>Impact</a>
    <!-- Navbar Search Input-->
    <!-- * * Note: * * Visible only on and above the lg breakpoint-->
    <form class="form-inline me-auto d-none d-lg-block me-3 w-75">
        <div class="input-group input-group-joined input-group-solid rounded-pill">
